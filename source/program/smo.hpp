...
/* SMO 1.0.0 (main build ID 3CA12DFAAF9C82DA064D1698DF79CDA1) .text offsets, from OdysseyDecomp data/file_list.yml. */
namespace smo {
    ...
    constexpr u8 BuildId[16] = {
        0x3c, 0xa1, 0x2d, 0xfa, 0xaf, 0x9c, 0x82, 0xda,
        0x06, 0x4d, 0x16, 0x98, 0xdf, 0x79, 0xcd, 0xa1,
    };
}
...
namespace smo::offsets {
    ...
    /* al::Projection::setProj(near, far, fovy, aspect) and calcMtx: the full projection rebuild, for fovy blending. */
